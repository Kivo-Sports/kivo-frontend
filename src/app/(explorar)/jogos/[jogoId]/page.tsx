...
import { VendaIngressos } from "@/components/organisms/VendaIngressos";
...
export default function ExplorarJogoDetalhePage({
  params,
}: {
        ...
        >
          ...
          >
            {partida.finalizado ? (
              ...
              >
                {partida.golsTimeCasa} <span style={{ color: "var(--color-text-muted)" }}>×</span>{" "}
